...
if($count_y > 0){?>
    <div class="row">
        ...
        foreach($row_y as $data_y){
                        ...
                        <div class="row">
                            <div class="col s12 m12"> 
                                <ol class="breadcrumbs mb-0">
                                    <li class="breadcrumb-item">Select Subject to view Lesson Plan: </li>
            ...
            <a href="?year_dashboard=<?php echo $year_dashboard;?>&class_dashboard=<?php echo $class_dashboard;?>&section_dashboard=<?php echo $section_dashboard;?>&lesson_plan=1&lesson_plan_of_subject=<?php echo $data_y['id'];?>">
