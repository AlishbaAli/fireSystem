<?php
$sql_y 		= "	SELECT DISTINCT b.year_name, c.class_name, h.id, h.first_name, h.middle_name, h.last_name, g1.subject_name
                    ...
                    <div class="container">
                        ...
                        <div class="col s12 m12"> 
                                <ol class="breadcrumbs mb-0">
                                    <li class="breadcrumb-item active">Subjects: <?php echo $data_y['first_name'];?> <?php echo $data_y['middle_name'];?> <?php echo $data_y['last_name'];?></li>
            ...
            <div class="col s12 m3">
                <div class="<?php echo $dashboard_section_classes;?>">
                    <div class="card-content center">
                        ...
                        <img src="app-assets/images/icon/subject.png" class="width-20 z-depth-5 responsive-img" alt="<?php echo $data_y['class_name'];?>" title="<?php echo $data_y['class_name'];?>" />
                    </div>
                </div>
            </div>
        <?php }?> 
