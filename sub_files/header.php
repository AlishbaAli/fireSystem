		...
		<nav class="<?php echo $top_nav_layout; ?>">
		  ...
		  <?php */ ?>
				...
				<ul class="dropdown-content" id="profile-dropdown">
					...
					if ($count_d_c > 0) { ?>
						<li>
							<a class="grey-text text-darken-1" href="?string=<?php echo encrypt("module=user_profile&page=listing") ?>">
					...
					if ($count_d_c > 0) { ?>
						<li>
							<a class="grey-text text-darken-1" href="?string=<?php echo encrypt("module=change_password&page=listing") ?>">
