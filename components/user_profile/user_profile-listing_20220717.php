...
if (isset($is_Submit) && $is_Submit == 'Y') {
	...
	if ($_SESSION['user_type'] == 'Admin') {
		...
		if (isset($gender) && $gender == "") {
			$error['msg'] 	= "Select Gender";
			$gender_valid = "invalid";
		}
		if (isset($phone_no) && $phone_no == "") {
	...
	$sql_ee = "	SELECT a.*, a.profile_pic, b.company_name, b.about_desc, b.s_address
				FROM users a
					...
					<form method="post" autocomplete="off" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="input-field col m4 s12">
								...
								<input id="email" readonly type="text" name="email" value="<?php if (isset($email)) {
																								echo $email;
																							} ?>">
							...
							<div class="input-field col m2 s12">
								<i class="material-icons prefix pt-2">person_outline</i>
								<select id="gender" name="gender" class="validate <?php if (isset($gender_valid)) {
																						echo $gender_valid;
																					} ?>">
