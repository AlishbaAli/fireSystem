...
if (isset($is_Submit) && $is_Submit == 'Y') {
	...
	if (empty($error)) {
		if ($_SESSION['user_type'] == 'Admin') {
			...
			$sql_c_up = "UPDATE employee a
						 INNER JOIN users b ON b.emp_id = a.id
						 			SET a.fname 			= '" . $first_name . "',
										a.lname 			= '" . $last_name . "',
										a.email 			= '" . $email . "',
	...
	$sql_ee = "	SELECT a.*, a2.fname, lname, a.profile_pic, b.company_name, b.about_desc, b.s_address
				FROM users a
				LEFT JOIN employee a2 ON a2.id = a.emp_id
