...
$sql_cl 				= "	SELECT a.* FROM phonenumbertype a WHERE a.subscriber_users_id = '" . $subscriber_users_id . "' ORDER BY a.enabled DESC, a.phonenumbertype ";
//echo $sql_cl;
$result_cl 				= $db->query($conn, $sql_cl);
$count_cl 				= $db->counter($result_cl);
$page_heading 			= "Phone Nmber Type";
?>
<!-- BEGIN: Page Main-->
										...
										<div class="col s12">
											<table id="page-length-option" class="display">
												<thead>
													<tr>
														<th width="5%">S.No</th>
														<th>Phone Nmber Type</th>
														<th>Duplicate Allow</th>
													...
													if ($count_cl > 0) {
														...
														foreach ($row_cl as $data) {
															...
															<tr data-id="<?php echo $id; ?>">
																<td><?php echo $i + 1; ?></td>
																<td><?php echo $data['phonenumbertype']; ?></td>
																<td><?php if ($data['duplicatesallowed'] == 1) { ?>Yes<?php } else { ?> No<?php } ?></td>
